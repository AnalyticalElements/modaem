...
function cIWL_InfluenceP(cZ,cZC) result(cP)
...
function cIWL_InfluenceW(cZ,cZC) result(cW)
...
function cIWL_InfluenceF(cZ1,cZ2,cZC) result(cF)
  ...
  ! [ RETURN VALUE ]
  complex (kind=ModAEM_Real) :: cF(1,1)
  ! [ LOCALS ]
  complex (kind=ModAEM_Real) :: cP1(1,1),cP2(1,1)
  real (kind=ModAEM_Real) :: rX1,rX2,rY1,rY2,rXi,rBC(1,1)
...
function cIWL_InfluenceG(cZ,cZC) result(cG)
...
function cIWL_InfluenceQ() result(cQ)
  !! complex function cIWL_InfluenceQ
  !!
